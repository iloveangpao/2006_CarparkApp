...
class _MapScreenState extends State<MapScreen> {
  ...
  Set<Marker> _createMarkers() {
    return _carparks.map((carpark) {
      bool isFavouritecheck = favData.where((item) => item['cp_code'] == carpark.carparkNo).isNotEmpty;
      ...
      Widget markerWidget = Stack(
        children: [
          Icon(Icons.favorite_border_outlined, color: isFavouritecheck ? Colors.red : Colors.transparent),
      ...
      return Marker(
        ...
        infoWindow: InfoWindow(
          ...
          onTap: () {
            bool isFavourite = favData.where((item) => item['cp_code'] == carpark.carparkNo).isNotEmpty;
            print(favData);
            showDialog(
              context: context,
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  actions: <Widget>[
                    TextButton(
                      child: Text(isFavourite ? 'Unfavorite' : 'Add to Favorites'),
                      onPressed: () {
                        if (isFavourite) {
                          print('lol');
                        } else {
